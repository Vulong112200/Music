<div class="col-md-6 col-md-offset-3" style="margin-top: 50px; margin-bottom: 100px;">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form action="index.php?controller=mv_type/edit&id=<?php echo $value["maLMV"] ?>&act=edit" method="post">
				<input type="text" name="oldname" class="form-control" readonly value="<?php echo $value["tenLMV"] ?>">
				...
				<a href="index.php?controller=mv_type/list" class="btn btn-success">Quay lại</a></center>
			</form>
		</div>
	</div>
</div>