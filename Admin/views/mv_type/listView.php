...
<div class="row">
			...
			<div class="panel-body">
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td><?php echo $value["tenLMV"] ?></td>
						<td><?php echo $value["Quocgia"] ?></td>
						<td>
							<a href="index.php?controller=mv_type/edit&id=<?php echo $value["maLMV"];?>">Update</a>
							<a href="index.php?controller=mv_type/list&id=<?php echo $value["maLMV"];?>&act=delete">Delete</a>
						</td>
					</tr>
					<?php } ?>
				</table>
	...
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="index.php?controller=mv_type/list&act=add" method="post">
