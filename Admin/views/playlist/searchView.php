...
<a href="index.php?controller=playlist/add" class="btn btn-primary" style="margin-bottom: 10px;">Thêm ca sĩ</a>
<a href="index.php?controller=playlist/list" class="btn btn-success" style="margin-bottom: 10px;">Quay lại</a>
